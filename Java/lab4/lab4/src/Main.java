...
public class Main{
    ...
    public static String file_name = "devices.txt";
    public static DeviceFileReader file_reader = new DeviceFileReader(file_name);
    ...
    public static void AddDevice(){
        ...
        switch (choise) {
            case 1:
                System.out.print("Заполненность травосборника (0-100): ");
                int container_level = in.nextInt();
                System.out.print("Острота ножей (0-100): ");
                int blade_sharpness = in.nextInt();
                System.out.print("Высота скашивания (2-15 см): ");
                ...
                break;
            case 2:
                System.out.print("Уровень воды в баке (0-100): ");
                int water_tank_level = in.nextInt();
                System.out.print("Длительность полива (1-120 мин): ");
                int watering_duration = in.nextInt();
                System.out.print("Влажность почвы (0-100): ");
                int soil_moisture = in.nextInt();
                System.out.print("Активная зона полива (1-10): ");
                ...
                break;
            case 3:
                System.out.print("Температура в теплице (0-60): ");
                int temperature = in.nextInt();
                System.out.print("Открытие окна (0-100): ");
                int window_opening = in.nextInt();
                System.out.print("Целевая температура (10-35): ");
                int target_temperature = in.nextInt();
                System.out.print("Скорость реакции (2-20): ");
    ...
    public static void readDevicesFromFile(){
        LinkedList<GardenDevice> read_devices = file_reader.readDevices();

        if (read_devices.isEmpty()) {
            System.out.println("Из файла не было прочитано ни одного устройства\n");
            System.out.println("Количество найденных объектов: " + file_reader.getFoundObjects());
            System.out.println("Количество успешно прочитанных свойств: " + file_reader.getFoundProperties());
            System.out.println("Количество не найденных свойств: " + file_reader.getMissingProperties() + "\n");
            return;
        }

        devices.addAll(read_devices);
        System.out.println("Из файла прочитано устройств: " + read_devices.size());
        System.out.println("Количество найденных объектов: " + file_reader.getFoundObjects());
        System.out.println("Количество успешно прочитанных свойств: " + file_reader.getFoundProperties());
        System.out.println("Количество не найденных свойств: " + file_reader.getMissingProperties() + "\n");
    }
    ...
    public static void changeFileName(){
        System.out.print("Введите новое название файла: ");
        file_name = in.next();
        file_reader.setFileName(file_name);
        System.out.println("Новое название файла установлено: " + file_name + "\n");
    }

    public static void showFileName(){
        System.out.println("Текущее название файла: " + file_reader.getFileName() + "\n");
    }
